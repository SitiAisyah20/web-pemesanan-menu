                    ...
                    <tbody class="table-border-bottom-0">
                      ...
                      <tr>
                        <td><?php echo $i;?></td>
                            ...
                            <td>
                              <a href="<?php echo site_url('kategori/getid/'.$item->idkat);?>" class="btn rounded-pill btn-warning"> 
                              Edit</a>   
                              <a href="<?php echo site_url('kategori/delete/'.$item->idkat);?>" class="btn rounded-pill btn-danger" 
                              onclick="return confirm('Are you sure delete this data?')"> Delete</a>
                            </td>
                      </tr>
                      <?php $i++; } ?>
                    </tbody>
