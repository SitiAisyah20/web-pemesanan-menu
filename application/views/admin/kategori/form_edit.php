          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Categories Management /</span> 
              Categories Data</h4>
                    ...
                    <div class="card-body">
                      ...
                      <input type="hidden" name="id" value="<?php echo $kategori->idkat;?>">
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" id="basic-default-name" name="namaKategori" 
                            placeholder="Category" value="<?php echo $kategori->namakat;?>" />
                          </div>
                        </div>
