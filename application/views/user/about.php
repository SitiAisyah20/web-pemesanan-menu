  ...
  <section class="about_section layout_padding">
    <div class="container  ">
      ...
      <div class="row">
        <div class="col-md-6 ">
          <div class="img-box">
            <img src="<?php echo base_url('assets/images/bg-5.jpg');?>" alt="">
          </div>
        </div>
        <div class="col-md-6">
          <div class="detail-box">
            <div class="heading_container">
              <h2>
                We Are Wedangan Lodji
              </h2>
            </div>
            <p>
            Wedangan Lodji didirikan tahun 2021, 
            bertempat di Jalan Pramuka, Kaliurang Timur adalah 
            restoran dengan desain interior joglo yang 
            memberikan kesan sederhana namun tetap nyaman. 
            Dengan aneka produk olahan rumahan membuat 
            wedangan lodji cocok untuk berkumpul dengan 
