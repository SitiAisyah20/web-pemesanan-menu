  ...
  <section class="food_section layout_padding-bottom">
    <div class="container">
              ...
              <div>
                ...
                <div class="detail-box">
                  ...
                  <div class="options">
                    ...
                    <a href="<?php echo site_url('user/addToCart/'.$item->idMenu);?>">
                      <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
                      x="0px" y="0px" viewBox="0 0 456.029 456.029" style="enable-background:new 0 0 456.029 456.029;" xml:space="preserve">
                        <g>
                          <g>
      ...
      <div class="filters-content">
        <div class="row grid">
          <?php foreach($vmakanan as $item) { ?>
          <div class="col-sm-6 col-lg-4 mb-4 all makanan">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="<?php echo base_url(); ?>uploads/<?php echo $item->gambar; ?>" alt="">
